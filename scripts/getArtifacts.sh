...
then
    ...
    wget --header="Accept: application/vnd.github+json" \
         --header="Authorization: Bearer ${NRN_MODELDB_CI_TOKEN}" \
         --header="X-GitHub-Api-Version: 2022-11-28" \
         --quiet --show-progress --output-document=drop.zip \
         "https://api.github.com/repos/neuronsimulator/nrn/actions/artifacts/${ARTIFACT_ID}/zip"
